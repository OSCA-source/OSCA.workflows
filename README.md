...
This repository contains a Bioconductor package to deploy the **Workflows** subbook of the **Orchestrating Single-Cell Analysis** book.
...
rebook::configureBook(prefix="Workflow")
```
