...
```{r trajectory}
# Using a lower 'outscale' to avoid connecting more distant dots;
# this is mostly to improve the aesthetics of the plot below.
library(TSCAN)
pseudo.out <- quickPseudotime(merged, use.dimred="corrected", 
    outgroup=TRUE, outscale=1.5)
```
...
pseudo.out2 <- quickPseudotime(merged, use.dimred="corrected", 
    dist.method="mnn", outgroup=TRUE, outscale=1.5)
